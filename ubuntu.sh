...
add_pkgs() {
    ...
    apt-get install -qq curl debconf-utils php-pear php8.4-curl php8.4-dev php8.4-gd php8.4-mbstring php8.4-zip php8.4-mysql php8.4-xml php8.4-fpm php8.4-intl php8.4-bcmath php-redis php8.4-xml php-zip php8.4-bcmath php-intl php-curl > /dev/null
